 ...
 *
 */
// TODO: Line 98 and 54 needed to be studied
#include <jni.h>
#include <errno.h>
#include <string.h>
#include <unistd.h>
        ...
        case APP_CMD_INPUT_CHANGED:
            ...
            if (android_app->inputQueue != NULL) {
                ...
                AInputQueue_attachLooper(android_app->inputQueue,
                                         android_app->looper, 0, (void*)LOOPER_ID_EVENT, NULL);
            }
...
static void* android_app_entry(void* param) {
    ...
    ALooper_addFd(looper, android_app->msgread, POLLIN, 0, (void*)LOOPER_ID_MAIN, NULL);
